...
DATA_TRAIN_PATH = os.path.join(
    os.path.dirname(__file__), "../..", "2_data/imagenette2-320"
)  # use relative directory path for train data
DATA_TEST_PATH = os.path.join(
    os.path.dirname(__file__), "../..", "2_data/imagenetwoof2-320"
)  # use relativ directory path for test data
